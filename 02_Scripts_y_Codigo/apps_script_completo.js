...
function onFormSubmit_F2(e) {
  try {
    ...
    var mapeoRequisitos = [
      ...
      { cumpleKey: "(d) Fotocopia de titulos",                obsKey: "Titulo Posgrado" },
      { cumpleKey: "(e) Fotocopia de la cedula",              obsKey: "Cedula" },
      { cumpleKey: "(f) Fotocopia de matricula",              obsKey: "Matricula / Tarjeta" },
      { cumpleKey: "(g) Certificado de inhabilidades",        obsKey: "delitos" },
      { cumpleKey: "(h) Certificado de registro",             obsKey: "deudores" },
      { cumpleKey: "(i) Certificacion de experiencia especifica", obsKey: "especifica en docencia" },
      { cumpleKey: "(j) Certificacion de experiencia en investigacion", obsKey: "experiencia en investigacion" },
      { cumpleKey: "(k) Certificacion de experiencia en extension", obsKey: "experiencia en extension" },
      { cumpleKey: "(l) Certificacion de experiencia en cargos", obsKey: "experiencia en cargos" },
      { cumpleKey: "(m) Certificacion de experiencia profesional", obsKey: "profesional diferente" },
      { cumpleKey: "(n) Certificacion de idiomas",             obsKey: "Idiomas Extranjeros" },
      { cumpleKey: "Documentos debidamente foliados",          obsKey: "foliados" },
      { cumpleKey: "Certificados disciplinarios",             obsKey: "disciplinarios" },
...
function crearDashboardNativo() {
  ...
  dashboard.getRange("A2:J2").merge()
    .setValue("ESTADISTICAS Y PANEL DE CONTROL RECTORIA — Actualizado: " + stats.actualizado)
  ...
  for (var p = 0; p < progList.length; p++) {
    ...
    dashboard.getRange("F" + filaProg).setValue(prog.count)
      .setFontWeight("bold").setFontSize(9).setHorizontalAlignment("center");
  ...
  if (diasData && diasData.length > 0) {
    ...
    for (var d = 0; d < diasData.length; d++) {
      ...
      dashboard.getRange("C" + dr).setValue(diasData[d].count)
        .setFontWeight("bold").setFontSize(10).setHorizontalAlignment("center")
        .setBackground("#eff6ff").setFontColor("#1d4ed8");
      dashboard.setRowHeight(dr, 20);
    }
